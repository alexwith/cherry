...
public class CherryTest {
    ...
    public static void main(String[] args) {
        ...
        final ProxiedClass<TestEntity> entityClass = ProxyFactory.createProxiedClass(TestEntity.class);
        final TestEntity entity = ProxyFactory.createProxiedEntity(entityClass);
